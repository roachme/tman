...
const char *errcodes[__LIBTMAN_STATUS_LAST] = {
    ...
    [LIBTMAN_PRJ_LOAD] = "could not load prject names",
    [LIBTMAN_PRJ_SAVE] = "could not save prject names",
    [LIBTMAN_PRJ_SWAP] = "could not swap prjects",
    [LIBTMAN_PRJ_TOOLONG] = "project name is too long, limit is " xstr(PRJSIZ),
    [LIBTMAN_PRJ_ILLEG] = "illegal prject name",
    [LIBTMAN_PRJ_NOCURR] = "no current prject",
    [LIBTMAN_PRJ_NOPREV] = "no previous prject",
    [LIBTMAN_PRJ_NOSUCH] = "no such project",
    [LIBTMAN_PRJ_EXISTS] = "prject already exists",
    [LIBTMAN_PRJ_SWITCH] = "could not switch to prject",
    [LIBTMAN_PRJ_DEL_CURR] = "could not unmark current prject",
